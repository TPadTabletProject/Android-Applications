...
public class HapticCanvasActivity extends Activity {

	// Used to initialize our screenview object for
	// drawing on to

	private static HapticCanvasView myBitmapView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.bitmapexampleview);
		...
		myBitmapView = (HapticCanvasView) findViewById(R.id.bitmapView);
